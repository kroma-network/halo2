...
use crate::{
    consts::{PCSType, RNGType},
    helpers::base_to_scalar,
...
pub mod ffi {
    ...
    unsafe extern "C++" {
        include!("halo2_proofs/include/bn254_poseidon_writer.h");
    ...
    unsafe extern "C++" {
        include!("halo2_proofs/include/bn254_rational_evals_view.h");
    ...
    unsafe extern "C++" {
        include!("halo2_proofs/include/bn254_prover.h");
...
impl fmt::Debug for ffi::PoseidonWriter {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("PoseidonWriter").finish()
    }
}

impl fmt::Debug for ffi::Sha256Writer {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("Sha256Writer").finish()
    }
}

impl fmt::Debug for ffi::SnarkVerifierPoseidonWriter {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("SnarkVerifierPoseidonWriter").finish()
    }
}
...
impl fmt::Debug for ffi::RationalEvalsView {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("RationalEvalsView").finish()
    }
}
